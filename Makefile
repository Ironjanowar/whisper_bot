...
start: token
	_build/$(MIX_ENV)/rel/whisper_bot/bin/whisper_bot daemon
...
stop:
	_build/$(MIX_ENV)/rel/whisper_bot/bin/whisper_bot stop

attach:
	_build/$(MIX_ENV)/rel/whisper_bot/bin/whisper_bot remote

release: deps compile
	mix release

debug: token
	_build/$(MIX_ENV)/rel/whisper_bot/bin/whisper_bot console
